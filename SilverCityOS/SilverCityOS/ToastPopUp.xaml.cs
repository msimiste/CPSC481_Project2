...
{
    /// <summary>
    /// Interaction logic for ToastPopUp.xaml
    /// </summary>
            ...
            : this(title)
        {
            switch (notificationType)
            {
                case NotificationType.Error:
                    this.imageLeft.Source = Properties.Resources.error1.ToBitmapImage();
                    break;

                case NotificationType.Information:
                    this.imageLeft.Source = Properties.Resources.information11.ToBitmapImage();
                    break;

                case NotificationType.Warning:
                    this.imageLeft.Source = Properties.Resources.warning11.ToBitmapImage();
                    break;
